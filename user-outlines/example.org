...
* org-mode
Get Org-9, woo!
#+include: "../nougat/packages/org.org" :only-contents t
* projectile

Tell projectile where to find your projects.
#+begin_src emacs-lisp
  (setq nougat-project-roo (expand-file-name "~/Projects"))
#+end_src

Then import the snippet:
#+include: "../nougat/packages/projectile.org"

* helm
Don't like Helm? Submit a PR with Ivy/Swyper nougats!
#+include: "../nougat/packages/helm.org"
