...
** org-olp
=org-olp= contains a number of elisp functions for working with Org-mode OLP paths.

Get it at http://github.com/dustinlacewell/org-olp

#+begin_src emacs-lisp
  (use-package org-olp
      :after (org)
      :straight (org-olp :type git :repo "/Users/dustinlacewell/src/org-olp"))
